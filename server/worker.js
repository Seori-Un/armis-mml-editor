...
/* ============================================================
   ...
   ============================================================ */
function buildEvents(groups, tempos, instrument, techs) {
...
const ALLOWED_ORIGINS = [
  // 배포한 GitHub Pages 주소를 여기에 넣는다.
  // 예: "https://your-id.github.io"
  // 비워 두면(길이 0) 개발 중 편의를 위해 모든 출처를 허용한다.
  // 운영에 올릴 때는 반드시 실제 주소로 좁혀 두는 걸 추천한다.
];
