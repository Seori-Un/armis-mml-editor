...
ko:{
  ...
  "toolbar.pauseTip":"일시정지 — 한 번 더 누르면 처음으로",
  "toolbar.rewindTip":"재생을 시작했던 자리로",
...
en:{
  ...
  "toolbar.pauseTip":"Pause — press again to go back to the start",
  "toolbar.rewindTip":"Back to where playback began",
...
ja:{
  ...
  "toolbar.pauseTip":"一時停止 — もう一度押すと先頭へ",
  "toolbar.rewindTip":"再生を始めた位置へ",
...
zh:{
  ...
  "toolbar.pauseTip":"暂停 — 再按一次回到起点",
  "toolbar.rewindTip":"回到开始播放的位置",
