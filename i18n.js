...
ko:{
  ...
  "midi.modeVoices":"서스테인 (원본 소리 그대로)",
  ...
  "midi.modeText2":"· 합주: MIDI의 파트를 그대로 둡니다.\n· 서스테인: 겹치는 음을 성부로 갈라, 누르고 있는 음이 원본처럼 끝까지 울립니다. 필요한 만큼 트랙이 늘어나며(게임에서는 3트랙 = 한 사람), 피아노곡에 좋습니다.\n· 솔로: 파트를 전부 합쳐 한 사람이 연주할 세 트랙으로 만듭니다. 겹치는 음을 성부로 갈라 울림을 살리고, 넘치면 덜 중요한 음부터 덜어냅니다.",
...
en:{
  ...
  "midi.modeVoices":"Sustain (sound like the original)",
  ...
  "midi.modeText2":"· Ensemble: keeps the MIDI parts as they are.\n· Sustain: overlapping notes are split into voices so held notes ring their full length, like the original. Adds as many tracks as needed (in game, 3 tracks = one player). Great for piano pieces.\n· Solo: merges every part into three tracks for one player. Overlapping notes are split into voices to keep them ringing; if it still does not fit, the least important notes are trimmed.",
...
ja:{
  ...
  "midi.modeVoices":"サステイン（原曲どおりの響き）",
  ...
  "midi.modeText2":"· 合奏: MIDIのパートをそのまま使います。\n· サステイン: 重なる音を声部に分け、押さえた音が原曲どおり最後まで鳴ります。必要なだけトラックが増えます（ゲームでは3トラック＝1人）。ピアノ曲に最適。\n· ソロ: 全パートを合わせて1人で弾く3トラックにします。重なる音を声部に分けて響きを保ち、収まらなければ重要度の低い音から削ります。",
...
zh:{
  ...
  "midi.modeText2":"· 合奏: 保持MIDI的分轨不变。\n· 延音: 将重叠的音符分到不同声部，长按的音符会像原曲一样响满时值。会按需要增加音轨（游戏中3轨=1人）。适合钢琴曲。\n· 独奏: 合并所有分轨，做成一人演奏的三条音轨。重叠的音符分到不同声部以保留延音，若仍放不下则从次要音符开始删减。",
