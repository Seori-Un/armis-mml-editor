...
ko:{
  ...
  "audio.badModel":"AI 모델을 열지 못했습니다. model/model.onnx가 최신 파일인지 확인해 주세요.",
...
en:{
  ...
  "audio.badModel":"Could not open the AI model. Make sure model/model.onnx is the latest file.",
...
ja:{
  ...
  "audio.badModel":"AIモデルを開けませんでした。model/model.onnxが最新か確認してください。",
...
zh:{
  ...
  "audio.badModel":"无法打开AI模型。请确认model/model.onnx为最新文件。",
