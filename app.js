...
/* ============================================================
   재생 머리에서 자르기
   ============================================================
   노란 선이 지나는 자리에서 음을 둘로 나눈다. 앞토막과 뒤토막은
   이음줄로 이어 두므로, 나눈 직후의 소리는 나누기 전과 똑같다.
   MML 글자만 "c2" 에서 "c4&c4" 로 갈릴 뿐이다.

   왜 이어 두는가 — 자르기는 "여기서 소리를 끊겠다"가 아니라
   "여기에 경계를 하나 두겠다"는 뜻이기 때문이다. 경계가 생기면
   뒤토막만 골라 세기를 바꾸거나, 기법을 다르게 주거나, 지워서
   실제로 끊을 수 있다. 끊고 싶으면 나눈 뒤 이음줄 버튼을 한 번
   더 누르면 된다.
